...
const char* buybot_pistol[] =
{
	"deagle",
	"elite"
};
const char* buybot_armor[] =
{
	"vest",
	"vesthelm"
};
...
const char* antiaim_pitch_types[] =
{
	"Viewangle",
	"Emotion",
	"Up",
...
const char* antiaim_edging_types[] =
{
	"Wall detection",
	"Freestanding",
