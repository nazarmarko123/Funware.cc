...
bool G::should_send_packet;
bool G::disable_fake_lag;
bool G::is_fakewalking;
bool G::should_choke_packets;
bool G::is_freestanding;
bool G::is_edging;
bool G::can_shoot_someone;
bool G::is_jumping;
bool G::do_max_fake_lag;
int G::choke_amount;
float G::cheat_start_time;

void* G::last_cmd;
Vector G::real_angles;
Vector G::fake_angles;
