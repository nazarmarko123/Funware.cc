...
public:
	...
	void DrawSetColor(Color col)
	{
		...
		return CallVFunction< oDrawSetColor >(this, 14)(this, col);
	}
	...
	{
		typedef void(__thiscall* Fn)(void*, int, int, int, int);
		return CallVFunction<Fn>(this, 24)(this, r, g, b, a);
	}
	void DrawSetTextColorxd(Color col)
	{
	...
	{
		typedef void(__thiscall* Fn)(void*);
		return CallVFunction<Fn>(this, 68)(this);
	}
