...
class CTraceFilter1 : public ITraceFilter
{
public:
	bool ShouldHitCBaseEntity(CBaseEntity* pCBaseEntityHandle, int contentsMask)
	{
		return (pCBaseEntityHandle == pEntity);
	}
...
{
public:
	void TraceRayxd(const Ray_t &ray, unsigned int fMask, ITraceFilter* pTraceFilter, trace_t* pTrace)
	{
		typedef void(__thiscall* fnTraceRay)(void*, const Ray_t&, unsigned int, ITraceFilter*, trace_t*);
		CallVFunction<fnTraceRay>(this, 5)(this, ray, fMask, pTraceFilter, pTrace);
	}
	...
	void TraceRay(const Ray_t& ray, unsigned int fMask, ITraceFilter* filter, trace_t* trace)
	{
		...
		CallVFunction<fn>(this, 5)(this, ray, fMask, filter, trace);
	}
