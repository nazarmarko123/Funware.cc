...
Color CAW_Hitmarker::get_hitmarker_color(hitmarker_info hitmarker)
{
	...
	return Color(Clientvariables->Visuals.aimwarehitmarkercolor[0], Clientvariables->Visuals.aimwarehitmarkercolor[1], Clientvariables->Visuals.aimwarehitmarkercolor[2], 255);
