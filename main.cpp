...
#include "aimware.h"
#include "Skinchanger/recv.h"
#include "EventLog/NewEventLog.h"
#include "NewVMTHOOK/newhook.h"
...
ISteamGameCoordinator* g_SteamGameCoordinator;
...
void Init()
{
	...
	g_GlowObjManager = *(CGlowObjectManager**)(FindPatternIDA("client_panorama.dll", "0F 11 05 ? ? ? ? 83 C8 01 C7 05 ? ? ? ? 00 00 00 00") + 3);
	...
	con_filter_text->SetValue(XorStr("FunWare ")); //this has to be the same as the other ones for this to work
}
