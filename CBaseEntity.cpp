...
int CBaseEntity::GetSequenceActivity(int sequence)
{
	...
	static auto getSequenceActivity = (DWORD)(Utilities::Memory::FindPatternIDA(XorStr("client_panorama.dll"), XorStr("55 8B EC 83 7D 08 FF 56 8B F1 74 3D")));
...
void CBaseEntity::PreDataUpdate(DataUpdateType_txd updateType)
{
...
void CBaseEntity::SetAbsOrigin(const Vector& origin)
{
	...
	static SetAbsOriginFn SetAbsOrigin = (SetAbsOriginFn)FindPatternIDA("client_panorama.dll", "55 8B EC 83 E4 F8 51 53 56 57 8B F1 E8");
...
void CBaseEntity::SetAngle2(Vector wantedang)
{
	...
	static SetAngleFn SetAngle = (SetAngleFn)((DWORD)Utilities::Memory::FindPatternIDA("client_panorama.dll", "55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1"));
...
bool CBaseEntity::IsTargettingLocal()
{
	...
	if (tr.m_pEnt && tr.m_pEnt->GetTeamNum() != this->GetTeamNum())
		return true;
