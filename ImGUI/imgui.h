...
namespace ImGui
{
	...
	IMGUI_API bool         	SliderMessage(const char* label, int* v, int v_min, int v_max, int at_value_message, const char* value_message, const char* display_format = "%.0f");
...
enum ImGuiCol_
{
	...
	ImGuiCol_FrameBg,
	ImGuiCol_Frameout2,
	ImGuiCol_FrameOut,                                // Background of checkbox, radio button, plot, slider, text input
	...
	ImGuiCol_Buttontemp1,
	ImGuiCol_Buttontemp2,
