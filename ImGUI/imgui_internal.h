...
namespace ImGui
{
	...
	IMGUI_API void          RenderFrame2(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border, float rounding = 0.0f);
	...
	bool newSliderFloat(const char * label, float * v, float v_min, float v_max, const char * display_format, float power, ImVec2 size, ImVec4 color);
